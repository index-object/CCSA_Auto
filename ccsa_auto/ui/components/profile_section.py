    ...
    with ui.card().classes(
        ...
        def load_score_control_status_embedded():
            ...
            if user_info and user_info.get("id"):
                ...
                scores = AuthService.get_scores(external_token) if external_token else None
                ...
                with ui.row().classes("w-full justify-between items-center"):
                    with ui.column().classes("flex-1"):
                        ...
                        progress_color = (
                            "bg-green-500" if status == "ahead"
                            else "bg-blue-500" if status == "on_track"
                            else "bg-gray-400"
                        )
                        with ui.row().classes(
                    ...
                    status_color = (
                        "bg-green-100 text-green-800" if status == "ahead"
                        else "bg-blue-100 text-blue-800" if status == "on_track"
